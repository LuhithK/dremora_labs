...
import { Link, Shield, Clock, Users } from 'lucide-react';
  ...
  const solutions = [
    {
      ...
      description: 'Over the past 15 years, our large-scale software solutions have been successfully deployed across government agencies, telcos, utilities, banks, healthcare, and education sectors, serving millions of citizens throughout their lifetime.',
      link: 'READ MORE'
    },
    {
      icon: Clock,
      title: 'Enterprise Solutions',
      description: 'We provide enterprise-wide solutions that serves as digital backbone of organizations, enabling seamless data flow, automation, and decision-making across business units.',
      link: 'READ MORE'
    },
    {
      icon: Shield,
      title: 'Other Products and Solutions',
      description: 'We deliver cutting-edge, customized IT products and solutions designed to address your sector\'s unique challenges. Whether you operate in government, healthcare, finance, telecom, or education, our expertise ensures seamless digital transformation.',
      link: 'READ MORE'
    }
  ];
          ...
          <div className="grid md:grid-cols-3 gap-8 animate-fadeInUp">
            {solutions.map((solution, index) => (
              <div key={index} className="service-card text-center">
                ...
                <p className="text-gray-400 mb-8 leading-relaxed text-base">{solution.description}</p>
